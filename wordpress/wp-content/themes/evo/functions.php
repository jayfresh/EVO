...
add_image_size( 'homeinfolinks', 1230, 388, true ); //double width to account for sprite, extra height to account for the unused top part of the image (displays only the bottom 324px)
